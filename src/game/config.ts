...
export const TOWER_CONFIG: Record<TowerType, {
  ...
  repair_drone: { hp: 170, description: 'Deploys drones that repair damaged buildings or attack nearby enemies.', color: '#2dd4bf', width: 4, height: 4, maxPower: 2, maxShieldHp: 0, shieldRadius: 0 },
};
...
export const SHOP_ITEM_CONFIG = {
  ...
  gatling: { kind: 'machine', name: 'Gatling', price: 25, towerType: 'gatling' },
  sniper: { kind: 'machine', name: 'Sniper', price: 25, towerType: 'sniper' },
  tesla: { kind: 'machine', name: 'Tesla', price: 25, towerType: 'tesla' },
  ...
  add_input: { kind: 'command_card', name: 'Add Input', price: 25, commandCardType: 'add_input' },
  add_output: { kind: 'command_card', name: 'Add Output', price: 25, commandCardType: 'add_output' },
  self_power: { kind: 'command_card', name: 'Self Power', price: 25, commandCardType: 'self_power' },
  range_boost: { kind: 'command_card', name: 'Range Boost', price: 25, commandCardType: 'range_boost' },

...
const en: I18nStrings = {
  ...
  towerDesc: {
    ...
    missile: 'Long-range launcher with four silos. Each missile costs 2 power and lands with splash damage.',
  ...
  pickDesc: {
    ...
    'missile_1': 'Four silos, 2 power per arcing missile',
...
const zh: I18nStrings = {
  ...
  towerDesc: {
    ...
    battery: '存储4格电，快速放电。',
    bus: '合并最多3条输入线为3条输出。',
    missile: '四宫格导弹发射井，每枚导弹消耗2格电，抛物线追踪并造成范围伤害。',
  ...
  pickDesc: {
    ...
    'battery_1': '存储能量，快速放电',
    'bus_1': '合并3条输入为3条输出',
    'missile_1': '4个发射井，每2格电发射1枚抛物线追踪导弹',
